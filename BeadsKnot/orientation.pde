  ...
  void decide_orientation() {//orientationを決める
    ...
    for (int repeat=0; repeat<de.points.size(); repeat++) {
      ...
      if (new_joint.a!=0&&new_joint.b!=0) {
        ...
        if (de.points.get(beads_start).u1==new_joint.a) {
          beads_next=de.points.get(beads_start).u2;
        } else if (de.points.get(beads_start).u2==new_joint.a) {
          beads_next=de.points.get(beads_start).u1;
        } else if (de.points.get(beads_start).n1==new_joint.a) {
          beads_next=de.points.get(beads_start).n2;
        } else if (de.points.get(beads_start).n2==new_joint.a) {
          beads_next=de.points.get(beads_start).n1;
        }
      }
